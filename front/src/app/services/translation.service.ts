...
export class TranslationService {
  ...
  private diccionarios: Record<string, Record<string, string>> = {
    ...
    es: {
      ...
      'ENQUIRE_EMAIL_LABEL': 'CORREO ELECTRÓNICO',
      'ENQUIRE_NAME_LABEL': 'NOMBRE COMPLETO',
      ...
      'SHOP_BUY_NOW': 'AÑADIR AL CARRITO',
